...
###### Hypothesis Testing series — [Part 1: Testing Proportions](http://emily-hk.com/testing-proportions/) · [Part 2: T-Tests & ANOVA](http://emily-hk.com/t-tests-and-more/) · Part 3: Chi-Squared Tests *(you are here)* · [Part 4: Non-Parametric Tests](http://emily-hk.com/non-parametric-tests/)