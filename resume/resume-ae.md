...
Senior data scientist with 10+ years at Reddit, Meta, and Spotify, focused on the analytics engineering layer: the metrics frameworks, data models, and pipelines that teams trust as their source of truth. Expert in SQL and dimensional modeling, with hands-on experience across BigQuery, Airflow, and ETL design. Consistently partners with engineering to turn raw event data into well-modeled, well-documented assets that power dashboards and decisions across the organization.
